...
dataset_other = dataset_orig.groupby(dataset_orig['sex'] == 0)
print(dataset_other[['age', 'education-num', 'race', 'sex', 'capital-loss', 'hours-per-week']].head(20))
...
# print(dataset_orig_joint[['age', 'education-num', 'race', 'sex', 'capital-loss', 'hours-per-week']].head(20))
